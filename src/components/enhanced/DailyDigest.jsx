...
export default function DailyDigest({ 
  ...
  const [selectedMember, setSelectedMember] = useState(currentUserId || collaborators[0]?.id);
  ...
  const currentDigest = memberDigests[selectedMember];
