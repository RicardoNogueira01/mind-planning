 ...
 */
export default function DependencyAnalyzer({ nodes, connections, onCreateConnection, onClose }: DependencyAnalyzerProps) {
    ...
    const getReasonText = (pattern: DependencyPattern, fromText: string, toText: string): string => {
    ...
    const suggestions = useMemo<Suggestion[]>(() => {
        ...
        const potentialDeps: Suggestion[] = [];
    ...
    const handleCreateConnection = (fromId: string, toId: string): void => {
    ...
    const handleDismiss = (suggestionId: string): void => {
