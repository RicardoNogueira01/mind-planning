...
const getMockRules = (): ReminderRule[] => [
    {
        id: '1',
...
const getMockStats = (): ReminderStats => ({
    totalOverdue: 6,
    dueToday: 3,
    dueThisWeek: 12,
...
export default function ReminderRulesSettings() {
    ...
    const handleEditRule = (rule: ReminderRule): void => {
        setFormData({
            name: rule.name,
                        ...
                        <div className="p-6 space-y-6">
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    onChange={(e: ChangeEvent<HTMLSelectElement>) => setFormData({ ...formData, daysBefore: parseInt(e.target.value) })}
                                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent text-gray-900"
                                >
                                ...
                                <div className="space-y-2">
                                    <label className="flex items-center gap-2 cursor-pointer">
                                        <input
                                            ...
                                            onChange={(e: ChangeEvent<HTMLInputElement>) => setFormData({ ...formData, notifyOwner: e.target.checked })}
                                    ...
                                    <label className="flex items-center gap-2 cursor-pointer">
                                        <input
                                            ...
                                            onChange={(e: ChangeEvent<HTMLInputElement>) => setFormData({ ...formData, notifyManager: e.target.checked })}
                                            className="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"
                                        />
                                    ...
                                    <label className="flex items-center gap-2 cursor-pointer">
                                        <input
                                            ...
                                            onChange={(e: ChangeEvent<HTMLInputElement>) => setFormData({ ...formData, notifyCreator: e.target.checked })}
                                            className="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"
                                        />
                                ...
                                <div className="space-y-2">
                                    <label className="flex items-center gap-2 cursor-pointer">
                                        <input
                                            ...
                                            onChange={(e: ChangeEvent<HTMLInputElement>) => setFormData({ ...formData, sendInApp: e.target.checked })}
                                            className="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"
                                        />
                                    ...
                                    <label className="flex items-center gap-2 cursor-pointer">
                                        <input
                                            ...
                                            onChange={(e: ChangeEvent<HTMLInputElement>) => setFormData({ ...formData, sendEmail: e.target.checked })}
                                            className="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"
                                        />
