...
interface ParentSelectionDialogProps {
    parentSelectionState: ParentSelectionState | null;
    onClose: () => void;
    onSelectParent: (nodeId: string, parentId: string) => void;
}

/**
 * Parent Selection Dialog - Choose which parent connection to remove
 */
const ParentSelectionDialog: React.FC<ParentSelectionDialogProps> = ({
