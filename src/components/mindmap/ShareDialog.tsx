...
interface ShareDialogProps {
    ...
    setSharePermission: (permission: string) => void;
    shareLink: string;
    shareVisitors: ShareVisitor[];
    onGenerateLink: () => void;
    onCopyLink: () => void;
    formatVisitorTime: (timestamp: string | Date) => string;
                    ...
                    <div className="space-y-2">
                        <label className="flex items-center gap-2 sm:gap-3 p-2 sm:p-3 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50 transition-colors touch-manipulation">
                            <input
                                ...
                                onChange={(e: ChangeEvent<HTMLInputElement>) => setSharePermission(e.target.value)}
