    ...
    <div className="absolute top-4 left-4 z-20 bg-white/95 shadow-xl border border-gray-200/50 rounded-2xl p-3">
      <div className="flex items-center gap-1">
        ...
        <div className="flex items-center gap-1 px-2 py-1 rounded-lg bg-gray-50/50">
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.8" strokeLinecap="round" strokeLinejoin="round" style={{shapeRendering: 'crispEdges'}} className={historyIndex > 0 ? 'group-hover:scale-110 transition-transform duration-200' : ''}>
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.8" strokeLinecap="round" strokeLinejoin="round" style={{shapeRendering: 'crispEdges'}} className={historyIndex < history.length - 1 ? 'group-hover:scale-110 transition-transform duration-200' : ''}>
