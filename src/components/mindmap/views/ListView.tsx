...
import { List, Search, ChevronDown, AlertCircle } from 'lucide-react';
...
type SortField = 'name' | 'dueDate' | 'priority' | 'progress' | 'status';
 ...
 */
const ListView: React.FC<ListViewProps> = ({ nodes }) => {
    ...
    const formatDueDate = (dateString?: string): DueDateInfo => {
