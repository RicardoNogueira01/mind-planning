 ...
 */
const GanttView = ({ nodes, connections }) => {
  ...
  const tasks = useMemo(() => {
    return nodes.map(node => {
      ...
      const startDate = dueDate ? new Date(dueDate.getTime() - 7 * 24 * 60 * 60 * 1000) : null; // 7 days before due
          ...
          <div className="flex border border-gray-300 rounded-lg overflow-hidden">
            <button
              ...
              className={`px-3 py-1.5 text-sm font-medium transition-colors ${
                viewMode === 'week' ? 'bg-black text-white' : 'bg-white text-gray-600 hover:bg-gray-50'
              }`}
            >
              Week
            </button>
            <button
              ...
              className={`px-3 py-1.5 text-sm font-medium transition-colors border-l border-gray-300 ${
                viewMode === 'month' ? 'bg-black text-white' : 'bg-white text-gray-600 hover:bg-gray-50'
              }`}
            >
              Month
            </button>
            <button
              ...
              className={`px-3 py-1.5 text-sm font-medium transition-colors border-l border-gray-300 ${
                viewMode === 'quarter' ? 'bg-black text-white' : 'bg-white text-gray-600 hover:bg-gray-50'
              }`}
            >
              Quarter
            </button>
