 ...
 */
export default function NodeToolbarContentGroup({
  node,
  isDarkMode,
  attachBtnRef,
  onToggleAttachment,
...
NodeToolbarContentGroup.propTypes = {
  node: PropTypes.object.isRequired,
  isDarkMode: PropTypes.bool,
  attachBtnRef: PropTypes.any,
  onToggleAttachment: PropTypes.func,
  renderAttachmentPopup: PropTypes.func,
  notesBtnRef: PropTypes.any,
  onToggleNotes: PropTypes.func,
  renderNotesPopup: PropTypes.func,
  tagsBtnRef: PropTypes.any,
  onToggleTags: PropTypes.func,
  renderTagsPopup: PropTypes.func,
};
