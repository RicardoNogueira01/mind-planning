...
const DeleteConfirmDialog: React.FC<DeleteConfirmDialogProps> = ({
    ...
    const [showDeleteAllDropdown, setShowDeleteAllDropdown] = useState<boolean>(false);
    ...
    const implications = useMemo<Implication[]>(() => {
        ...
        return list;
    }, [hasChildren, childrenCount, nodeText, isMultiSelect]);
