...
interface NodeToolbarLayoutProps {
    shouldRender?: boolean;
    layoutBtnRef?: RefObject<HTMLButtonElement>;
    onToggleLayout?: (e: MouseEvent<HTMLButtonElement>) => void;
    renderLayoutPopup?: () => ReactNode;
}
 ...
 */
const NodeToolbarLayout: React.FC<NodeToolbarLayoutProps> = ({
    shouldRender,
    layoutBtnRef,
    onToggleLayout,
    renderLayoutPopup,
...
export default NodeToolbarLayout;
