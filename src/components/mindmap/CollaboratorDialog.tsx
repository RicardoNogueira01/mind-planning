...
interface CollaboratorDialogProps {
    showCollaboratorDialog: boolean;
    setShowCollaboratorDialog: (show: boolean) => void;
    selectedNodes: string[];
    setSelectedNodes: (nodes: string[]) => void;
    collaborators: Collaborator[];
    assignCollaborator: (nodeIdOrCollaborator: string | Collaborator, collaboratorId?: string) => void;
    collaboratorNodeId?: string | null;
    setCollaboratorNodeId?: (nodeId: string | null) => void;
    nodes?: Node[];
}

const CollaboratorDialog: React.FC<CollaboratorDialogProps> = ({
    ...
    const pageItems = useMemo(() => filtered.slice((currentPage - 1) * pageSize, (currentPage - 1) * pageSize + pageSize), [filtered, currentPage, pageSize]);
