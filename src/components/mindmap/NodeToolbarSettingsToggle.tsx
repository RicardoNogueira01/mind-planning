...
interface NodeToolbarSettingsToggleProps {
    isToolbarExpanded?: boolean;
    onToggle?: () => void;
}

const NodeToolbarSettingsToggle: React.FC<NodeToolbarSettingsToggleProps> = ({
    isToolbarExpanded,
    onToggle
}) => {
    return (
...
export default NodeToolbarSettingsToggle;
