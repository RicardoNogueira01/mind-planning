 ...
 */
export default function NodeToolbarMetaGroup({
  detailsBtnRef,
  onToggleDetails,
  renderDetailsPopup,
  dateBtnRef,
...
NodeToolbarMetaGroup.propTypes = {
  detailsBtnRef: PropTypes.any,
  onToggleDetails: PropTypes.func,
  renderDetailsPopup: PropTypes.func,
  dateBtnRef: PropTypes.any,
  onToggleDate: PropTypes.func,
  renderDatePopup: PropTypes.func,
  collabBtnRef: PropTypes.any,
  onToggleCollaborator: PropTypes.func,
  renderCollaboratorPopup: PropTypes.func,
};
