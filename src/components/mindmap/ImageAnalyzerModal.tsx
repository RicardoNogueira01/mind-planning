...
interface ImageAnalyzerModalProps {
    isOpen: boolean;
    onClose: () => void;
    onAnalyze: (data: MindMapData) => void;
}
...
const ImageAnalyzerModal: React.FC<ImageAnalyzerModalProps> = ({ isOpen, onClose, onAnalyze }) => {
    ...
    const handleAnalyze = async (): Promise<void> => {
        ...
        try {
            ...
            if (errorObj.message.includes('403') || errorObj.message.includes('API key')) {
                ...
                errorMessage += errorObj.message || 'Please try again or check the console for details.';
            }
