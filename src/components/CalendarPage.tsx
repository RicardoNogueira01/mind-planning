...
const CalendarPage: React.FC = () => {
    ...
    const holidays: Holiday[] = sharedHolidays as Holiday[];
    const events: CalendarEvent[] = sharedEvents as CalendarEvent[];
    const categories: string[] = sharedCategories as string[];
