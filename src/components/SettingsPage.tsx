...
const SettingsPage: React.FC = () => {
    ...
    const handleToggle = (key: keyof Settings): void => {
                        ...
                        >
                            <div className="space-y-4">
                                <SelectInput
                                    ...
                                    onChange={(e: ChangeEvent<HTMLSelectElement>) => handleChange('profileVisibility', e.target.value)}
                                    options={[
                        ...
                        >
                            <div className="space-y-4">
                                <SelectInput
                                    ...
                                    onChange={(e: ChangeEvent<HTMLSelectElement>) => handleChange('theme', e.target.value)}
                                    options={[
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <SelectInput
                                        ...
                                        onChange={(e: ChangeEvent<HTMLSelectElement>) => handleChange('dateFormat', e.target.value)}
                                        options={[
                                    ...
                                    <SelectInput
                                        ...
                                        onChange={(e: ChangeEvent<HTMLSelectElement>) => handleChange('timeFormat', e.target.value)}
                                        options={[
                        ...
                        >
                            <div className="space-y-4">
                                ...
                                <SelectInput
                                    ...
                                    onChange={(e: ChangeEvent<HTMLSelectElement>) => handleChange('sessionTimeout', e.target.value)}
                                    options={[
