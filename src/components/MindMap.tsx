...
// @ts-nocheck - Large file, types will be added incrementally
...
const NodeToolbarWrapper: React.FC<NodeToolbarWrapperProps> = ({ isMobile, children }) => {
  if (isMobile) {
    return createPortal(
...
export default function MindMap({ mapId, onBack }: MindMapProps) {
  // @ts-ignore
