...
const TeamHolidaysManager: React.FC = () => {
    const { t } = useLanguage();
    ...
    const [teamHolidayRequests, setTeamHolidayRequests] = useState<HolidayRequest[]>([
        {
            id: 1,
    ...
    const handleApprove = (id: number, employeeName: string): void => {
    ...
    const handleReject = (id: number, employeeName: string): void => {
    ...
    const handleDelete = (id: number, employeeName: string): void => {
