...
export const templates: Template[] = [
  // 1. Project Planning Template
  {
    ...
    nodeStructure: {
      nodes: [
        ...
        { text: 'Goals', x: -250, y: -150, bgColor: '#10B981', fontColor: '#FFFFFF' },
        { text: 'Timeline', x: 250, y: -150, bgColor: '#F59E0B', fontColor: '#FFFFFF' },
        { text: 'Resources', x: -250, y: 150, bgColor: '#8B5CF6', fontColor: '#FFFFFF' },
        { text: 'Risks & Challenges', x: 250, y: 150, bgColor: '#EF4444', fontColor: '#FFFFFF' },
        { text: 'Goal 1', x: -400, y: -250, bgColor: '#34D399', fontColor: '#FFFFFF' },
        { text: 'Goal 2', x: -400, y: -150, bgColor: '#34D399', fontColor: '#FFFFFF' },
        { text: 'Goal 3', x: -400, y: -50, bgColor: '#34D399', fontColor: '#FFFFFF' },
        { text: 'Phase 1', x: 400, y: -250, bgColor: '#FBBF24', fontColor: '#FFFFFF' },
        { text: 'Phase 2', x: 400, y: -150, bgColor: '#FBBF24', fontColor: '#FFFFFF' },
        { text: 'Phase 3', x: 400, y: -50, bgColor: '#FBBF24', fontColor: '#FFFFFF' },
        { text: 'Team', x: -400, y: 100, bgColor: '#A78BFA', fontColor: '#FFFFFF' },
        { text: 'Budget', x: -400, y: 200, bgColor: '#A78BFA', fontColor: '#FFFFFF' },
        { text: 'Risk 1', x: 400, y: 100, bgColor: '#F87171', fontColor: '#FFFFFF' },
        { text: 'Risk 2', x: 400, y: 200, bgColor: '#F87171', fontColor: '#FFFFFF' },
      ],
      connections: [
        { from: 'root', to: 'goals' },
  ...
  // 2. Meeting Notes Template
  {
    ...
    nodeStructure: {
      nodes: [
        ...
        { text: 'Attendees', x: -250, y: -200, bgColor: '#8B5CF6', fontColor: '#FFFFFF' },
        { text: 'Agenda', x: 250, y: -200, bgColor: '#10B981', fontColor: '#FFFFFF' },
        { text: 'Discussion Points', x: -250, y: 100, bgColor: '#F59E0B', fontColor: '#FFFFFF' },
        { text: 'Action Items', x: 250, y: 100, bgColor: '#EF4444', fontColor: '#FFFFFF' },
        { text: 'Person 1', x: -400, y: -250, bgColor: '#A78BFA', fontColor: '#FFFFFF' },
        { text: 'Person 2', x: -400, y: -150, bgColor: '#A78BFA', fontColor: '#FFFFFF' },
        { text: 'Topic 1', x: 400, y: -250, bgColor: '#34D399', fontColor: '#FFFFFF' },
        { text: 'Topic 2', x: 400, y: -150, bgColor: '#34D399', fontColor: '#FFFFFF' },
        { text: 'Discussion 1', x: -400, y: 50, bgColor: '#FBBF24', fontColor: '#FFFFFF' },
        { text: 'Discussion 2', x: -400, y: 150, bgColor: '#FBBF24', fontColor: '#FFFFFF' },
        { text: 'Action 1', x: 400, y: 50, bgColor: '#F87171', fontColor: '#FFFFFF' },
        { text: 'Action 2', x: 400, y: 150, bgColor: '#F87171', fontColor: '#FFFFFF' },
      ],
      connections: [
  ...
  // 3. SWOT Analysis Template
  {
    ...
    nodeStructure: {
      nodes: [
        ...
        { text: 'Strengths', x: -250, y: -200, bgColor: '#10B981', fontColor: '#FFFFFF' },
        { text: 'Weaknesses', x: 250, y: -200, bgColor: '#EF4444', fontColor: '#FFFFFF' },
        { text: 'Opportunities', x: -250, y: 200, bgColor: '#3B82F6', fontColor: '#FFFFFF' },
        { text: 'Threats', x: 250, y: 200, bgColor: '#F59E0B', fontColor: '#FFFFFF' },
        { text: 'Strong brand', x: -450, y: -280, bgColor: '#34D399', fontColor: '#FFFFFF' },
        { text: 'Skilled team', x: -450, y: -200, bgColor: '#34D399', fontColor: '#FFFFFF' },
        { text: 'Good reputation', x: -450, y: -120, bgColor: '#34D399', fontColor: '#FFFFFF' },
        { text: 'Limited budget', x: 450, y: -280, bgColor: '#F87171', fontColor: '#FFFFFF' },
        { text: 'Small team', x: 450, y: -200, bgColor: '#F87171', fontColor: '#FFFFFF' },
        { text: 'Old technology', x: 450, y: -120, bgColor: '#F87171', fontColor: '#FFFFFF' },
        { text: 'Market growth', x: -450, y: 120, bgColor: '#60A5FA', fontColor: '#FFFFFF' },
        { text: 'New technology', x: -450, y: 200, bgColor: '#60A5FA', fontColor: '#FFFFFF' },
        { text: 'Partnerships', x: -450, y: 280, bgColor: '#60A5FA', fontColor: '#FFFFFF' },
        { text: 'Competition', x: 450, y: 120, bgColor: '#FBBF24', fontColor: '#FFFFFF' },
        { text: 'Economic downturn', x: 450, y: 200, bgColor: '#FBBF24', fontColor: '#FFFFFF' },
        { text: 'Regulations', x: 450, y: 280, bgColor: '#FBBF24', fontColor: '#FFFFFF' },
      ],
      connections: [
  ...
  // 6. Weekly Planning Template
  {
    ...
    description: 'Organize your week with daily tasks and priorities. Perfect for personal productivity.',
    category: 'personal',
    thumbnail: '📅',
    tags: ['planning', 'weekly', 'tasks', 'personal', 'productivity'],
    nodeStructure: {
      nodes: [
        { text: 'Week Planning', x: 0, y: 0, bgColor: '#3B82F6', fontColor: '#FFFFFF' },
        { text: 'Monday', x: -400, y: -200, bgColor: '#10B981', fontColor: '#FFFFFF' },
        { text: 'Tuesday', x: -200, y: -250, bgColor: '#10B981', fontColor: '#FFFFFF' },
        { text: 'Wednesday', x: 0, y: -280, bgColor: '#10B981', fontColor: '#FFFFFF' },
        { text: 'Thursday', x: 200, y: -250, bgColor: '#10B981', fontColor: '#FFFFFF' },
        { text: 'Friday', x: 400, y: -200, bgColor: '#10B981', fontColor: '#FFFFFF' },
        { text: 'Weekend Goals', x: 0, y: 200, bgColor: '#8B5CF6', fontColor: '#FFFFFF' },
        { text: 'Task 1', x: -400, y: -300, bgColor: '#34D399', fontColor: '#FFFFFF' },
        { text: 'Task 2', x: -400, y: -350, bgColor: '#34D399', fontColor: '#FFFFFF' },
      ],
      connections: [
        { from: 'root', to: 'monday' },
        { from: 'root', to: 'tuesday' },
        { from: 'root', to: 'wednesday' },
        { from: 'root', to: 'thursday' },
        { from: 'root', to: 'friday' },
        { from: 'root', to: 'weekend' },
        { from: 'monday', to: 'task1' },
        { from: 'monday', to: 'task2' },
      ],
      layout: 'spider-web'
    },
    customization: {
