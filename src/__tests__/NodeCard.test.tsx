...
describe('NodeCard Component', () => {
    ...
    const renderNodeCard = (props: Record<string, unknown> = {}) => {
        const defaultProps = {
            node: defaultNode,
            selected: false,
            onSelect: vi.fn(),
        ...
        return render(<NodeCard {...defaultProps as any} />);
    };

    describe('Width Calculation', () => {
        it('should have minimum width for short text', () => {
            renderNodeCard({ node: { ...defaultNode, text: 'Hi' } });
            const nodeElement = document.querySelector('[data-node-id="test-node-1"]') as HTMLElement;
        ...
        it('should account for emoji in width calculation', () => {
            ...
            const nodeWithEmoji = document.querySelector('[data-node-id="test-node-emoji"]') as HTMLElement;
            ...
            const nodeNoEmoji = document.querySelector('[data-node-id="test-node-no-emoji"]') as HTMLElement;
